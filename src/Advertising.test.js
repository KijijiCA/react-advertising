    ...
    describe('When I instantiate an advertising main module', () => {
        ...
        describe('and call the setup method', () => {
            ...
            describe('the price granularity for Prebid', () => {
                ...
                it('is set correctly', () =>
                    void expect(global.pbjs.setPriceGranularity.firstCall.args).toMatchSnapshot());
            });
            describe('the bidder sequence for Prebid', () => {
                it('is set', () => void expect(global.pbjs.setBidderSequence).to.have.been.calledOnce);
                it('is set correctly', () =>
                    void expect(global.pbjs.setBidderSequence.firstCall.args).toMatchSnapshot());
            });
            ...
            describe('initial loading of ad creatives through GPT', () =>
                it('is disabled', () =>
                    void expect(global.googletag.pubads().disableInitialLoad).to.have.been.calledOnce));
            ...
            describe('global GPT targeting parameters', () =>
                it('are set correctly', () =>
                    void expect(global.googletag.pubads().setTargeting.args).toMatchSnapshot()));
            describe('GPT single request mode', () =>
                it('is enabled', () =>
                    void expect(global.googletag.pubads().enableSingleRequest).to.have.been.calledOnce));
            ...
            describe("the background color of the ad slot's DOM element", () =>
                it('is not changed', () =>
                    void expect(fakeElement.style.backgroundColor).to.equal('shmackground-color')));
            describe("the background image of the ad slot's DOM element", () =>
                it('is not changed', () =>
                    void expect(fakeElement.style.backgroundImage).to.equal('shmackground-image')));
            ...
            describe('and I activate the “foo” ad', () => {
                ...
                describe('the targeting for asynchronous GPT', () =>
                    it('is set correctly', () =>
                        void expect(global.pbjs.setTargetingForGPTAsync.args).toMatchSnapshot()));
